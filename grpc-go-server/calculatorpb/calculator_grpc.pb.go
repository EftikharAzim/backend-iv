...
type CalculatorClient interface {
	...
	Subtract(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddReply, error)
	Multiply(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddReply, error)
	Divide(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddReply, error)
}
...
func (c *calculatorClient) Subtract(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddReply)
...
func (c *calculatorClient) Multiply(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddReply)
...
func (c *calculatorClient) Divide(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddReply)
...
type CalculatorServer interface {
	...
	Subtract(context.Context, *AddRequest) (*AddReply, error)
	Multiply(context.Context, *AddRequest) (*AddReply, error)
	Divide(context.Context, *AddRequest) (*AddReply, error)
...
func (UnimplementedCalculatorServer) Subtract(context.Context, *AddRequest) (*AddReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Subtract not implemented")
}
func (UnimplementedCalculatorServer) Multiply(context.Context, *AddRequest) (*AddReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Multiply not implemented")
}
func (UnimplementedCalculatorServer) Divide(context.Context, *AddRequest) (*AddReply, error) {
...
func _Calculator_Subtract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Subtract(ctx, req.(*AddRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calculator_Divide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Divide(ctx, req.(*AddRequest))
	}
	return interceptor(ctx, in, info, handler)
}
