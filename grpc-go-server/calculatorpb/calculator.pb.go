...
const file_calculator_proto_rawDesc = "" +
	...
	"\bAddReply\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result2\x9d\x01\n" +
	"\n" +
	"Calculator\x12\x1f\n" +
	"\x03Add\x12\v.AddRequest\x1a\t.AddReply\"\x00\x12$\n" +
	"\bSubtract\x12\v.AddRequest\x1a\t.AddReply\"\x00\x12$\n" +
	"\bMultiply\x12\v.AddRequest\x1a\t.AddReply\"\x00\x12\"\n" +
	"\x06Divide\x12\v.AddRequest\x1a\t.AddReply\"\x00B\x1dZ\x1b./calculatorpb;calculatorpbb\x06proto3"
...
var file_calculator_proto_depIdxs = []int32{
	...
	0, // 1: Calculator.Subtract:input_type -> AddRequest
	0, // 2: Calculator.Multiply:input_type -> AddRequest
	0, // 3: Calculator.Divide:input_type -> AddRequest
	1, // 4: Calculator.Add:output_type -> AddReply
	1, // 5: Calculator.Subtract:output_type -> AddReply
	1, // 6: Calculator.Multiply:output_type -> AddReply
	1, // 7: Calculator.Divide:output_type -> AddReply
